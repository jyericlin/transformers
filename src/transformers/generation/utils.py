...
class GenerationMixin:
    ...
    def generate_splitted(
        ...
        **kwargs,
        ...
        if generation_mode == GenerationMode.GREEDY_SEARCH:
            ...
            return self.greedy_search_split(
                input_ids,
                logits_processor=logits_processor,
                stopping_criteria=stopping_criteria,
                pad_token_id=generation_config.pad_token_id,
    ...
    def greedy_search_start(
        ...
        **model_kwargs,
        ...
        return outputs, input_ids, logits_processor, stopping_criteria, pad_token_id, eos_token_id, \
            output_attentions, output_hidden_states, output_scores, return_dict_in_generate, synced_gpus, \
                streamer, model_kwargs, unfinished_sequences, eos_token_id_tensor, scores, this_peer_finished



    def greedy_search_continue(
        self,
        first_part_output,
        unfinished_sequences,
        eos_token_id_tensor,
        ...
        **model_kwargs,
        ...
        while True:
            outputs = self.forward_second_half(
                first_part_output[0],
                first_part_output[1],
                first_part_output[2],
                first_part_output[3],
                first_part_output[4],
                past_key_values=first_part_output[5],
                return_dict=True,
                output_attentions=output_attentions,
                output_hidden_states=output_hidden_states,
                use_cache=True,)
            ...
            if this_peer_finished and not synced_gpus:
                ...
                return input_ids, logits_processor, stopping_criteria, pad_token_id, eos_token_id, \
                    output_attentions, output_hidden_states, output_scores, return_dict_in_generate, synced_gpus, \
                        streamer, model_kwargs, unfinished_sequences, eos_token_id_tensor, scores, this_peer_finished 
    ...
    def greedy_search_split(
        ...
        **model_kwargs,
        ...
        while True:
            ...
            if type(outputs) == list and len(outputs) == 7:
                        
                        
                return outputs, input_ids, logits_processor, stopping_criteria, max_length, pad_token_id, eos_token_id, \
                    output_attentions, output_hidden_states, output_scores, return_dict_in_generate, synced_gpus, \
                        streamer, model_kwargs, unfinished_sequences, eos_token_id_tensor, scores, this_peer_finished
